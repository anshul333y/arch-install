...
pacman -S --noconfirm networkmanager dhcpcd bluez bluez-utils pipewire pipewire-pulse reflector cronie \
  dash zsh starship git openssh stow unzip noto-fonts noto-fonts-cjk noto-fonts-emoji \
  ...
  uwsm brightnessctl acpi pacman-contrib python-pywal rsync ntfs-3g libreoffice-fresh \
  firefox flatpak yazi poppler mpv yt-dlp mpd timidity++ mpc ncmpcpp sxiv xorg-xrdb htop btop \
